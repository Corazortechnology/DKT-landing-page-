    ...
    <section id="login-gateway" className="py-16 px-6 md:px-20 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {[
            { label: "Donor", path: "https://dkt-client.vercel.app/auth/sign-in" },
            { label: "Vendor", path: "https://dkt-client.vercel.app/auth/sign-in" },
            { label: "School", path: "https://dkt-client.vercel.app/auth/sign-in" },
            { label: "Admin", path: "https://dkt-client.vercel.app/auth/sign-in" },
          ].map((item, index) => (
