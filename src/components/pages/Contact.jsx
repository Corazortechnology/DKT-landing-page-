  ...
  return (
    <section className="min-h-screen mt-12 px-6 md:px-20 py-16 text-gray-800">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-10">
        <h1
          id="contact"
          className="text-4xl md:text-5xl font-bold text-center text-[#WCAGAA] mb-4"
        >
          Let’s Partner to Power Purpose
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-[16px]">
                1705 Bldg 4C, Whispering Palms 4 Co-Op. HSG. SOC. LTD,
                Akurli Road, Lokhandwala Township, Kandivali East,<br />
                Mumbai Suburb Maharashtra,400101
              </p>
            </div>
